...
def main():
    ...
    cv2.namedWindow('360 Photo Booth with Frame', cv2.WINDOW_NORMAL)

    # Set the window to be maximized by default
    cv2.setWindowProperty('360 Photo Booth with Frame', cv2.WND_PROP_FULLSCREEN, cv2.WINDOW_FULLSCREEN)
